    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div
            className="relative bg-gry-50 border
          ...
          >
            {form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
                className="w-full h-full objecg-contain"
              />
            ) : (
              <img
                src={preview}
            ...
            justify-center items-center bg-[rgba(0,0,0,5)] rounded-lg"
              >
                <Loader />
              </div>
            )}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Oncle you have created the image you want, you can share ut with
